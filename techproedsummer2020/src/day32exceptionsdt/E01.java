...
public class E01 {
	...
	*/
	...
	/*
	  ...
	  classes you have to use child exception class first. Otherwise you will get CTE
	*/
	
	/*
	  Finally block runs under any condition. If there is exception finally block runs, 
	  if there is no exception finally block does not run.
	*/
