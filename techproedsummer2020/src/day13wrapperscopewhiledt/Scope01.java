...
public class Scope01 {
	...
	public static void main(String[] args) {
		/*
		  ...
		  1) If you crate a variable inside the class body and outside the methods
		     you can use them in everywhere inside the class
		     Note: the variables created inside and outside the body are called 
		           "Instance Variables"
		     num1 is an Instance Variable, num1 can be used from everywhere inside the class
		     
		  2) If you create a variable inside method you can use it just inside 
		  ...
		  Question: What is the difference between "Instance Variable" and
		            ...
		            ==> Local variables must be initialized but if you want you may not 
		  ...
		  4) Do not try to use variable before declaration
		*/
	}
