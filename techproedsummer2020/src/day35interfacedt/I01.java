...
public interface I01 {
	...
	/*
	  ...
	  2)There are two types of abstraction 
	     a) Partial abstraction : If you create an abstract class, some methods are
	                              abstract, some are concrete. As you see, all methods 
	                              are not abstract because of that we are using abstract
	                              classes "partial abstraction".
	                              
	     b) Full abstraction : In full abstraction all  methods must be abstract. If you 
	                           use "interface", it must be all methods abstract inside an
	                           interface. Because of that using "interfaces" is named as
	                           "Full abstraction"
	                           
      3)In interfaces all methods are "abstract" automatically, because of that when you
        create a method no need to type "abstract"
      
      4)In interfaces all methods are "public" even you type it or not.
